...
{
    // The background colour will change, depending on cursor placement on screen
...
// Provide user with letters to select, being in a confusing order 
const alphabet = 'RZKTFXEUGHMIJLPNBOCSVWYAQD';
// Depending on their placement, the letters would translate to incorrect letters 
...
enter.addEventListener('click', () => 
{
    ...
    {
        //window.location.href = '../intermission/inter.html';
        goToNextpage();
    } 
    else 
    {
